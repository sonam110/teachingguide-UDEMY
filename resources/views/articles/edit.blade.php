    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form method="post" action="{{ route('post.update', ['id' => $post->id]) }}" class="form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Tags</label>
                        <div class="col-sm-10">
                            ...
                            @foreach($post->tags as $tag)
                               <?php $dataTag[] = $tag->name; ?>
                            @endforeach
                            <input class="tagsinput form-control" type="text" value="{{ implode(',', $dataTag) }}" name="tags"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <textarea class="summernote form-control" name="body" rows="10"/>{{ $post->body }}</textarea>
                    </div>
