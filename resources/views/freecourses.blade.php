	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 hero-text">
				<h1 class="hero-head">Search Free Courses</h1>
...
$('#selAuthor, #selTopic, #selSubCat,  #includeTags, #IncKeyRel,.i-checks').on('change', function(e) {
 MyserchFilter();
});
...
<script>
  ...
  <link rel="stylesheet" type="text/css" href="/assets/css/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css">
