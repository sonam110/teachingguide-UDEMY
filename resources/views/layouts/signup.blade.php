...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/>
    <meta name="description" content="{{ isset($meta) ? $meta : 'Teachinguide provide competitive information for online instructor to succeed on Udemy and other learning platforms.'}}">
    ...
    <title>{{ isset($title) ? $title : 'Teachinguide - Become a Successful Instructor with Teachinguide.' }}</title>
